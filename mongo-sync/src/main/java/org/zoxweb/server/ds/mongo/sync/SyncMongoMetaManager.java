...
public class SyncMongoMetaManager
{
	 ...
	 */
	public boolean isIndexed(MongoCollection collection)
	{
	 ...
	 */
	public synchronized void addCollectionInfo(MongoCollection collection, NVConfigEntity nvce)
	{
	 ...
	 */
	private synchronized void addUniqueIndexes(MongoCollection collection, NVConfigEntity nvce)
	{
		if (!isIndexed(collection))
		{
